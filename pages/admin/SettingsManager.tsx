                    ...
                    <ul className="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                        {tabs.map((tab) => (
                            <li key={tab.id} className="nav-item">
                                ...
                                >
                                    <i className={`fas fa-${tab.id === 'hero' ? 'layer-group' : tab.id === 'statistics' ? 'chart-bar' : tab.id === 'process' ? 'tasks' : tab.id === 'localization' ? 'language' : tab.id === 'labels' ? 'font' : tab.id === 'general' ? 'phone' : tab.id === 'social' ? 'share-alt' : 'envelope'} mr-1`}></i>
                                    {tab.label}
                                </a>
                            </li>
                        ))}
