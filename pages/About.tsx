          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-9 animate-in fade-in slide-in-from-right-4 duration-700">
              ...
              {activeTab === 'about' && (
                <div className="space-y-16">
                  <div className="space-y-8">
                    <h2 className="text-3xl font-black text-primary uppercase italic tracking-tight">{aboutData.title.split(' ').slice(0, -1).join(' ')} <span className="text-accent">{aboutData.title.split(' ').slice(-1)}</span></h2>
              ...
              {activeTab === 'team' && (
                <div className="space-y-12">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {aboutData.team.map((person: any, idx: number) => (
              ...
              {activeTab === 'testimonials' && (
                <div className="space-y-12">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {aboutData.testimonials.map((review: any, idx: number) => (
